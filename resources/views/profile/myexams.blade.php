                ...
                <x-table.body>
                    @foreach($exams as $exam)
                        <x-table.row>
                            ...
                            <x-table.cell hideMobile='true'>@if ($exam->visibility) <span class="badge badge-{{ config('color.public') }}">Public</span> @else <span class="badge badge-{{ config('color.private') }}">Private</span> @endif </x-table.cell>
                            <x-table.cell>
