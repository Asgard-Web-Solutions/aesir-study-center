    ...
    <div class="flex items-center">
        ...
        <div class="w-full sm:w-10/12 md:w-8/12 m-auto bg-gray-200 rounded-lg">
            ...
            <div class="w-full my-2">
                <div class="w-full">
                    @foreach ($sets as $set)
                        <div class="w-full text-center p-2"><a href="{{ route('manage-questions', $set->id) }}" class="px-3 bg-gray-800 rounded-lg text-white">{{ $set->name }}</a></div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="w-full my-2 text-center">
                <form action="{{ route('save-exam') }}" method="post">
                    ...
                    <br /><br />
                    <label class="p-2">Description</label><br />
